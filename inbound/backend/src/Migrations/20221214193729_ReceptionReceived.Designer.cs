...
namespace backend.Migrations
{
    ...
    [Migration("20221214193729_ReceptionReceived")]
    partial class ReceptionReceived
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.ASN", b =>
                {
                    ...
                    b.Property<int?>("ReceptionReceivedId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ReceptionReceivedId");
            ...
            modelBuilder.Entity("backend.Models.Kafka.ReceptionReceived", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("backend.Models.ASN", b =>
                {
                    ...
                    b.HasOne("backend.Models.Kafka.ReceptionReceived", "ReceptionReceived")
                        .WithMany()
                        .HasForeignKey("ReceptionReceivedId");

                    b.Navigation("PurchaseOrder");

                    b.Navigation("ReceptionCreated");

                    b.Navigation("ReceptionReceived");
                });
